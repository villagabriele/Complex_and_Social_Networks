...
## Topics of the labs
The labs cover several topics regarding Social Networks and their analysis. In particular, these are what the labs focus on:
- LAB 01: Introduction to igraph (with Ilaria Boschetto)
- LAB 02: Analysis of the degree distribution on PUD database (with Raffaele D'Agostino)
- LAB 03: Significance of network metrics (with Giulia Pinciroli)
